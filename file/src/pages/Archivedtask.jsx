              ...
              {filteredTasks.length === 0 ? (
                <tr>
                  <td colSpan="7" className="status-task-empty">
                    {isLoading ? "Loading tasks..." : searchQuery ? "No matching archived tasks found." : "No saved archived tasks found."}
                  </td>
                </tr>
                ...
                <tr key={task.id}>
                  <td>
                    ...
                    {task.subtitle && <div className="status-task-subtitle">{task.subtitle}</div>}
                  </td>
                  <td>
                  ...
                  <td className="status-task-action-cell">
                    <button type="button" className="status-task-menu" aria-label="Task actions">
