...
const { mcubeInbound, mcubeRecordingWebhook, mcubeWebhook } = require("./controller/call.controller")
...
app.post("/api/integrations/mcube/recording", mcubeRecordingWebhook)
