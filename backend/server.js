...
const { mcubeInbound, mcubeWebhook } = require("./controller/call.controller")
...
const mcubeRouter = require("./router/mcube.routes")
...
app.post("/api/integrations/mcube", mcubeRouter)
...
// app.get("/api/integrations/mcube/recording", mcuberecor)
